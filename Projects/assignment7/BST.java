...
import Projects.assignment5.Container;
...
class BST implements Container
{
  ...
  //we must return the new or unchanged value of r as our function value
	//because we are faking pass-by-reference (b/c technically java is always pass-by-value)
  {
  ...
  public static final int PRE = 0;				//Preorder
  public static final int IN = 1;				//Inorder
  public static final int POST = 2;				//Postorder
